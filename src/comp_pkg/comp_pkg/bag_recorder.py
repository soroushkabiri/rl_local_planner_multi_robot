...
class BagRecorderNode(Node):
    def __init__(self):
        ...
        self.topics = [
            ...
            "/robot0_1/v_hat", "/robot1_0/v_hat", "/robot1_1/v_hat",
            "/robot0_1/yaw_hat", "/robot1_0/yaw_hat", "/robot1_1/yaw_hat",
            "/robot0_1/yaw_deg", "/robot1_0/yaw_deg", "/robot1_1/yaw_deg", "/robot0_0/yaw_deg",
            "/robot0_1/cmd_vel", "/robot1_0/cmd_vel", "/robot1_1/cmd_vel"
        ]

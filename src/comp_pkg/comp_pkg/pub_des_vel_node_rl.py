...
class XHatToCmdNode(Node):
    def __init__(self):
        ...
        self.create_subscription(Float32, 'linear_velocity_rl', self.rl_lin_vel_callback, 10)
        # Variable to store the received velocity
        self.linear_velocity_rl = 0.0
...
#        self.fig, self.ax = plt.subplots(figsize=(10,6))
    ...
    def rl_lin_vel_callback(self,msg):
        self.linear_velocity_rl = msg.data
    ...
    def timer_callback(self):
        ...
        for name in self.robot_names:
            ...
            cmd_msg.linear.x = self.linear_velocity_rl

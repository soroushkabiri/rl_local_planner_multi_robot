...
tmux new-session -d -s ros_sim "./1_hide_launch.sh" \; \
split-window -v "sleep 15; ./2_launch.sh" \; \
split-window -h "sleep 30; ./3_launch.sh" \; \
split-window -v "sleep 40; ./4_launch.sh" \; \
split-window -h "sleep 50; ./5_launch.sh" \; \
split-window -v "sleep 62; ./6_launch.sh" \; \
split-window -h "sleep 88; ./7_launch.sh" \; \
